    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('range', models.ForeignKey(help_text='Rango de cantidad asociado a esta comisión', on_delete=django.db.models.deletion.CASCADE, related_name='commissions', to='coin.range')),
            ],
            options={
